...
{
 "use strict";
 var Global,Task1XKQCNV,Client,WebSharper,Obj,UI,Var$1,Var,Operators,Unchecked,JavaScript,JS,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,Handler,Task1XKQCNV_Templates,ConcreteVar,Snap,Pervasives,System,Guid,Collections,List,Client$1,Templates,Doc,Abbrev,Fresh,Dictionary,Object,HashSet,Seq,TemplateInitializer,EventTarget,Node,View,Numeric,AttrProxy,CheckedInput,DictionaryUtil,Enumerator,T,SC$1,WindowOrWorkerGlobalScope,Docs,SC$2,DocElemNode,CharacterData,Elt,Prepare,Slice,DomUtility,KeyCollection,An,Settings,Mailbox,Attrs,Dyn,Attrs$1,AttrModule,List$1,T$1,Strings,Array,Updates,ValueCollection,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$3,HashSetUtil,BindVar,SC$4,SC$5,AppendList,SC$6,DynamicAttrNode,Scheduler,Easing,AsyncBody,SC$7,CT,HashSet$1,String,CancellationTokenSource,DomNodes,Char,Error,OperationCanceledException,Lazy,SC$8,Queue,LazyExtensionsProxy,LazyRecord,Math,IntelliFactory,Runtime$1,console,Date;
 Global=self;
 Task1XKQCNV=Global.Task1XKQCNV=Global.Task1XKQCNV||{};
 Client=Task1XKQCNV.Client=Task1XKQCNV.Client||{};
 ...
 Task1XKQCNV_Templates=Global.Task1XKQCNV_Templates=Global.Task1XKQCNV_Templates||{};
 ...
 {
  var inputTemp,inputResult,inputEquation,a,b,t,t$1,t$2,t$3,t$4,t$5,t$6,t$7,t$8,t$9,t$10,t$11,t$12,t$13,t$14,t$15,t$16,t$17,t$18,t$19,t$20,t$21,_this,_this$1,_this$2,p,i;
  function ClearTemp()
  {
   inputTemp.Set("0");
  }
  ...
  function inputAdd(x)
  {
   if(x===-1)
   {
    if(Unchecked.Equals(inputTemp.Get().indexOf(".")!=-1,false))
     inputTemp.Set(inputTemp.Get()+".");
   }
   else
    if(inputTemp.Get()!=="0"&&x===0)
     inputTemp.Set(inputTemp.Get()+"0");
    else
     if(inputTemp.Get()==="0")
      inputTemp.Set(Global.String(x));
     else
      inputTemp.Set(inputTemp.Get()+Global.String(x));
  }
  function TempToResult()
  {
   inputResult.Set(inputTemp.Get());
  }
  function calculateResult(x)
  {
   var c,c$1,c$2,c$3,c$4,c$5,c$6;
   x==="="?TempToResult():void 0;
   x==="+"?inputResult.Get()===""?TempToResult():inputResult.Set((c=Global.Number(inputResult.Get())+Global.Number(inputTemp.Get()),Global.String(c))):void 0;
   x==="-"?inputResult.Get()===""?TempToResult():inputResult.Set((c$1=Global.Number(inputResult.Get())-Global.Number(inputTemp.Get()),Global.String(c$1))):void 0;
   x==="*"?inputResult.Get()===""?TempToResult():inputResult.Set((c$2=Global.Number(inputResult.Get())*Global.Number(inputTemp.Get()),Global.String(c$2))):void 0;
   x==="/"?(inputResult.Get()===""?TempToResult():inputResult.Set((c$3=Global.Number(inputResult.Get())/Global.Number(inputTemp.Get()),Global.String(c$3))),inputResult.Get()==="Infinity"?Global.alert(function($1)
   {
    return $1("Nem lehet null\ufffdval osztani!");
   }(Global.id)):void 0):void 0;
   x==="Sin"?(inputResult.Get()===""?TempToResult():void 0,inputResult.Set((c$4=Math.sin(Global.Number(inputResult.Get())),Global.String(c$4))),ClearOnputEquation()):void 0;
   x==="Cos"?(inputResult.Get()===""?TempToResult():void 0,inputResult.Set((c$5=Math.cos(Global.Number(inputResult.Get())),Global.String(c$5))),ClearOnputEquation()):void 0;
   x==="1/x"?(inputResult.Get()===""?TempToResult():void 0,inputResult.Set((c$6=1/Global.Number(inputResult.Get()),Global.String(c$6))),ClearOnputEquation()):void 0;
   x!==""?ClearTemp():void 0;
   inputResult.Get()==="NaN"?Global.alert(function($1)
   {
    return $1("Hiba - Nincs eredm\ufffdnye a sz\ufffdmol\ufffdsnak!");
   }(Global.id)):void 0;
  }
  inputTemp=Var$1.Create$1("0");
  inputResult=Var$1.Create$1("");
  inputEquation=Var$1.Create$1("=");
  a=(b=(t=(t$1=(t$2=(t$3=(t$4=(t$5=(t$6=(t$7=(t$8=(t$9=(t$10=(t$11=(t$12=(t$13=(t$14=(t$15=(t$16=(t$17=(t$18=(t$19=(t$20=(t$21=(_this=(_this$1=(_this$2=new ProviderBuilder.New$1(),(_this$2.h.push({
   $:8,
   $0:"input",
   $1:inputTemp
   ...
   $0:"equation",
   $1:inputEquation
  }),_this)),(t$21.h.push(Handler.EventQ2(t$21.k,"clear",function()
  {
   return t$21.i;
  },function()
  {
   ClearTemp();
  })),t$21)),(t$20.h.push(Handler.EventQ2(t$20.k,"allclear",function()
  {
   return t$20.i;
  },function()
  {
   ...
   ClearTemp();
   ClearResult();
  })),t$20)),(t$19.h.push(Handler.EventQ2(t$19.k,"copyresult",function()
  {
   return t$19.i;
  },function()
  {
   inputTemp.Set(inputResult.Get());
  })),t$19)),(t$18.h.push(Handler.EventQ2(t$18.k,"add_comma",function()
  {
   return t$18.i;
  },function()
  {
   inputAdd(-1);
  })),t$18)),(t$17.h.push(Handler.EventQ2(t$17.k,"add_0",function()
  {
   return t$17.i;
  },function()
  {
   inputAdd(0);
  })),t$17)),(t$16.h.push(Handler.EventQ2(t$16.k,"add_1",function()
  {
   return t$16.i;
  },function()
  {
   inputAdd(1);
  })),t$16)),(t$15.h.push(Handler.EventQ2(t$15.k,"add_2",function()
  {
   return t$15.i;
  },function()
  {
   inputAdd(2);
  })),t$15)),(t$14.h.push(Handler.EventQ2(t$14.k,"add_3",function()
  {
   return t$14.i;
  },function()
  {
   inputAdd(3);
  })),t$14)),(t$13.h.push(Handler.EventQ2(t$13.k,"add_4",function()
  {
   return t$13.i;
  },function()
  {
   inputAdd(4);
  })),t$13)),(t$12.h.push(Handler.EventQ2(t$12.k,"add_5",function()
  {
   return t$12.i;
  },function()
  {
   inputAdd(5);
  })),t$12)),(t$11.h.push(Handler.EventQ2(t$11.k,"add_6",function()
  {
   return t$11.i;
  },function()
  {
   inputAdd(6);
  })),t$11)),(t$10.h.push(Handler.EventQ2(t$10.k,"add_7",function()
  {
   return t$10.i;
  },function()
  {
   inputAdd(7);
  })),t$10)),(t$9.h.push(Handler.EventQ2(t$9.k,"add_8",function()
  {
   return t$9.i;
  },function()
  {
   inputAdd(8);
  })),t$9)),(t$8.h.push(Handler.EventQ2(t$8.k,"add_9",function()
  {
   return t$8.i;
  },function()
  {
   inputAdd(9);
  })),t$8)),(t$7.h.push(Handler.EventQ2(t$7.k,"calculate",function()
  {
   return t$7.i;
  },function()
  {
   calculateResult(inputEquation.Get());
   inputEquation.Set("=");
  })),t$7)),(t$6.h.push(Handler.EventQ2(t$6.k,"plus",function()
  {
   return t$6.i;
  },function()
  {
   calculateResult(inputEquation.Get());
   inputEquation.Set("+");
  })),t$6)),(t$5.h.push(Handler.EventQ2(t$5.k,"minus",function()
  {
   return t$5.i;
  },function()
  {
   calculateResult(inputEquation.Get());
   inputEquation.Set("-");
  })),t$5)),(t$4.h.push(Handler.EventQ2(t$4.k,"multiplication",function()
  {
   return t$4.i;
  },function()
  {
   calculateResult(inputEquation.Get());
   inputEquation.Set("*");
  })),t$4)),(t$3.h.push(Handler.EventQ2(t$3.k,"division",function()
  {
   return t$3.i;
  },function()
  {
   calculateResult(inputEquation.Get());
   inputEquation.Set("/");
  })),t$3)),(t$2.h.push(Handler.EventQ2(t$2.k,"sin",function()
  {
   return t$2.i;
  },function()
  {
   inputEquation.Set("Sin");
   calculateResult(inputEquation.Get());
  })),t$2)),(t$1.h.push(Handler.EventQ2(t$1.k,"cos",function()
  {
   return t$1.i;
  },function()
  {
   inputEquation.Set("Cos");
   calculateResult(inputEquation.Get());
  })),t$1)),(t.h.push(Handler.EventQ2(t.k,"multiplicativeinverse",function()
  {
   return t.i;
  },function()
  {
   inputEquation.Set("1/x");
   calculateResult(inputEquation.Get());
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[["input",0],["equation",0],["inputresult",0]]),(i=new TemplateInstance.New(p[1],Task1XKQCNV_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 Task1XKQCNV_Templates.main=function(h)
 {
 ...
 SC$6.$cctor=function()
 {
  ...
  SC$6.EmptyAttr=null;
  SC$6.BoolCheckedApply=Runtime$1.Curried3(function(_var,el,cb)
  {
   return[el(function(el$1)
   {
  ...
  SC$6.StringApply=(g=BindVar.StringGet(),(s=BindVar.StringSet(),Runtime$1.Curried(BindVar.ApplyValue,3,[g,function($1,$2)
  {
   return(s($1))($2);
  }])));
  ...
  SC$6.IntApplyUnchecked=(g$1=BindVar.IntGetUnchecked(),(s$1=BindVar.IntSetUnchecked(),Runtime$1.Curried(BindVar.ApplyValue,3,[g$1,function($1,$2)
  {
   return(s$1($1))($2);
  }])));
  ...
  SC$6.IntApplyChecked=(g$2=BindVar.IntGetChecked(),(s$2=BindVar.IntSetChecked(),Runtime$1.Curried(BindVar.ApplyValue,3,[g$2,function($1,$2)
  {
   return(s$2($1))($2);
  }])));
  ...
  SC$6.FloatApplyUnchecked=(g$3=BindVar.FloatGetUnchecked(),(s$3=BindVar.FloatSetUnchecked(),Runtime$1.Curried(BindVar.ApplyValue,3,[g$3,function($1,$2)
  {
   return(s$3($1))($2);
  }])));
  ...
  SC$6.FloatApplyChecked=(g$4=BindVar.FloatGetChecked(),(s$4=BindVar.FloatSetChecked(),Runtime$1.Curried(BindVar.ApplyValue,3,[g$4,function($1,$2)
  {
   return(s$4($1))($2);
  }])));
 };
